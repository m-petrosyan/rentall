<template>
    <section>
        <div class="relative p-4 w-full" v-if="kit && kitOptions && !loading">
            <div class="p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form @submit.prevent="createUpdateKitQuery" class="flex flex-col gap-y-10">
                    ...
                    <div class="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        ...
                        <router-link :to="{name: 'db-kit', params:{page: 1}}"
...
export default {
    ...
    methods: {
        ...mapActions(['createKit', 'updateKit', 'optionsKit', 'getKit']),
        getData() {
            if (this.update) {
                this.getKit(this.$route.params.id)
            }
            this.optionsKit()
            this.loading = false
        },
