<template>
    <div class="relative p-4 w-full" v-if="product && !loading">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <select v-model="product.data.category.id"
                                ...
                                <option v-for="category in product.categories" :key="category.id"
                                        :value="category.id">
                                    {{ category.title }}
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <select v-model="product.data.brand.id"
                                    id="brand"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option v-for="brand in product.brands" :key="brand.id" :value="brand.id">
                                    {{ brand.title }}
                                </option>
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <v-select
                            ...
                            multiple="true"
                            :options="product.kits" label="title"
                    ...
                    <div>
                        ...
                        <v-select
                            class="p-1.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            multiple="true"
                            :options="product.similars" label="title"
                            v-model="product.data.similar_products"/>
                    </div>
                    <div class="mb-4 space-y-4 sm:flex sm:space-y-0">
                        <div class="mr-4">
                            ...
                            <div id="inline-checkbox" class="mt-square-garden ">
                                <input id="1" type="checkbox" v-model="product.data.slider" :false-value="0"
                                       :true-value="1"/>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        placeholder="Write product description here" :value="product.data.description"></textarea></div>
                </div>
                <div class="mb-4">
...
export default {
    ...
    methods: {
        ...
        getProductQuery() {
            return this.editProduct(this.$route.params.id)
        },
    },
    computed: {
        product() {
